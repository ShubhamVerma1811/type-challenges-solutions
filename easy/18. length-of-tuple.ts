...
// I like this because it extends the length and infers the type rather than having to specify it
...
/*
 ...
 Problem with this is, that it only works for arrays, not tuples.
